		...
		switch (opcion){
			case 1:
				...
				while(bandera != 0){
					...
					printf("\nIngrese contrase%ca: \n", -92); // se escribe de esa manera para que aparezca la � por pantalla
					...
					strcpy(cadAux, contra); // Se utiliza una cadena auxiliar para copiar la contrase�a ingresada
					...
					// Se agrupan todos los valores booleanos falsos para pedir que ingrese una nueva contrase�a
					...
					// y aceptar la contrase�a ingresada
				...
				fwrite(&veterinario, sizeof(vet), 1, Veterinarios); //Se escribre el usuario y la contrase�a en el archivo
		    ...
		    case 2:
				...
				while(bandera != 0){
					...
					//Se juntan todos los valores booleanos verdaderos para cambiar el valor de bandera y solicitar la contrase�a del usuario
					if(enunciadoA == true && enunciadoB == true && enunciadoC == true && enunciadoD == true){
						bandera = 0;
					}
				}
				...
				bandera = 1; //Al cambiar el valor de la bandera se acepta el usuario y solicita contrase�a del mismo
				...
				while(bandera != 0){
					...
					// Al igual que el caso 1 se codifica de la misma manera el ingreso de contrase�a del usuario
					strcpy(cadAux, contra); //El contenido de la cadena contrase�a se copia en la cadAux
					...
					if(strlen(contra) < 6 || strlen(contra) > 32){ //Condicion de longitud de la contrase�a
						printf("Contrase%ca no cumple con la condicion \"C.\"\n", -92);
					}
					else{
						enunciadoC = true;
					...
					//Se juntan todos los valores booleanos falsos para volver a solicitar una contrase�a
					if(enunciadoA == false || enunciadoB == false || enunciadoC == false || enunciadoD == false || enunciadoE == false){
						printf("\nPresione una tecla para volver a ingresar...");
						getch();
						system("cls");
					}
					//Se juntan todos los valores booleanos verdaderos para aceptar la contrase�a, cambiando el valor de la bandera
					if(enunciadoA == true && enunciadoB == true && enunciadoC == true && enunciadoD == true && enunciadoE == true){
						bandera = 0;
					}
				}
